...
- (void)viewDidLoad {
   ...
   // self.view.bounds = contentRect;
	...
	self.view.backgroundColor = [[UIColor alloc] initWithRed:0 green:0 blue:0 alpha:1];
...
//	[self.view addSubview:searchBar];
	...
	//candleChart
	self.candleChart = [[Chart alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width-44, self.view.frame.size.height)];
	...
	[self.candleChartFreqView setBackgroundColor:[[UIColor alloc] initWithRed:148/255.f green:148/255.f blue:148/255.f alpha:0]];
...
//	[self.toolBar addSubview:status];	
    toolBar.backgroundColor = [[UIColor alloc] initWithRed:0 green:0 blue:0 alpha:1];
